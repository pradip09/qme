...
$sql_res = "SELECT * FROM video_album WHERE 1 $ssql ";	
...
$sql_cus = "SELECT * FROM video_album where 1 $ssql order by iVideoAlbumId $var_limit";	

$db_videoalbum= $obj->MySQLSelect($sql_cus);
...
if(!count($db_videoalbum)>0 && $keyword != ""){
