...
$sql = "SELECT * FROM estimate_orders WHERE 1 $ssql";	
...
$sql_cat = "SELECT * FROM  estimate_orders where 1 $ssql order by iEstimateDetailId DESC $var_limit";	
...
$sql_alp = "select vTitle from estimate_orders where 1=1";
