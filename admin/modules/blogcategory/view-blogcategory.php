...
$sql_cus = "SELECT * FROM blogcategory where 1 $ssql order by iBlogCategoryId $var_limit";	

$db_blogcategory= $obj->MySQLSelect($sql_cus);
...
if(!count($db_blogcategory)>0 && $keyword != ""){
