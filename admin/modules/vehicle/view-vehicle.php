...
$sql_res = "SELECT * FROM vehicle_type WHERE 1 $ssql ";	
$db_res = $obj->MySQLSelect($sql_res);
$num_totrec = count($db_res);
include(TPATH_CLASS_GEN."paging.inc.php");

#Listing Starts from here
$sql_cus = "SELECT * FROM vehicle_type where 1 $ssql order by iVehicleTypeId DESC $var_limit";	
$db_vehicle= $obj->MySQLSelect($sql_cus);
...
$sql_alp = "select vName from vehicle_type where 1=1";
...
$smarty->assign("db_vehicle",$db_vehicle);
