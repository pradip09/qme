...
$sql_res = "SELECT * FROM system_email WHERE 1 $ssql ";	
...
$sql_cus = "SELECT * FROM system_email where 1 $ssql order by iEmailTemplateId DESC LIMIT 0,10";	
$db_system_email= $obj->MySQLSelect($sql_cus);
...
$sql_alp = "select vEmailTitle from system_email where 1=1";
