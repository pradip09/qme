...
$sql_res = "SELECT * FROM skill WHERE 1 $ssql ";	
$db_res = $obj->MySQLSelect($sql_res);
$num_totrec = count($db_res);
include(TPATH_CLASS_GEN."paging.inc.php");

#Listing Starts from here
$sql_cus = "SELECT * FROM skill where 1 $ssql order by iSkillId DESC $var_limit";	
$db_skill= $obj->MySQLSelect($sql_cus);
#ends here
...
$sql_alp = "select vSkill from skill where 1=1";
