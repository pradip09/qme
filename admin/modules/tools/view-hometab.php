...
$sql_res = "SELECT * FROM banner_tab WHERE 1 $ssql";	
$db_res = $obj->MySQLSelect($sql_res);
$num_totrec = count($db_res);
include(TPATH_CLASS_GEN."paging.inc.php");

$sql_cus = "SELECT * FROM banner_tab where 1 $ssql order by iBannerId DESC $var_limit";	
$db_hometab= $obj->MySQLSelect($sql_cus);
...
$sql_alp = "select vTitle from banner_tab where 1=1";
