...
$sql_res = "SELECT * FROM news_nfl WHERE 1 $ssql";	
$db_res = $obj->MySQLSelect($sql_res);
$num_totrec = count($db_res);
include(TPATH_CLASS_GEN."paging.inc.php");

$sql_cus = "SELECT * FROM news_nfl where 1 $ssql order by iNewsId DESC $var_limit";	
...
$sql_alp = "select vTitle from news_nfl where 1=1";
