...
$sql_res = "SELECT * FROM song_album WHERE 1 $ssql ";	
...
$sql_cus = "SELECT * FROM song_album where 1 $ssql order by iSongAlbumId $var_limit";	

$db_songalbum= $obj->MySQLSelect($sql_cus);
...
if(!count($db_songalbum)>0 && $keyword != ""){
