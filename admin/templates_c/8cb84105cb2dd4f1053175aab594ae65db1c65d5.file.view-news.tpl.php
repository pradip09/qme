<?php /* Smarty version Smarty-3.0.7, created on 2012-07-13 17:39:26
         compiled from "/var/www/qme_theme/admin/templates/news/view-news.tpl" */ ?>
<?php /*%%SmartyHeaderCode:135731975950000ff6951643-99862449%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8cb84105cb2dd4f1053175aab594ae65db1c65d5' => 
    array (
      0 => '/var/www/qme_theme/admin/templates/news/view-news.tpl',
      1 => 1342181354,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '135731975950000ff6951643-99862449',
  'function' => 
  array (
  ),
...
" id="type" name="type"><input type="button" value="Search" class="btn" id="Search" name="Search" title="Search" onclick="Searchoption();"/></td>
				<td width="10%">
				<input type="button" value="Add New" onclick="Redirect('index.php?file=n-news&mode=add');" class="btn" />
				</td>
			</tr>	
			<tr>
...
" title=""><?php echo $_smarty_tpl->getVariable('db_news')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vTitle'];?>
			...
			<td><?php echo $_smarty_tpl->getVariable('db_news')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iOrderNo'];?>
</td>
