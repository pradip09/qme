<?php /* Smarty version Smarty-3.0.7, created on 2013-06-06 08:36:43
         compiled from "/home/qmemedia/public_html/admin/templates/contests/contests.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18259216351b0906be91559-27158118%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ddecaa83311e24849a0fde067bc071d52bec9f5d' => 
    array (
      0 => '/home/qmemedia/public_html/admin/templates/contests/contests.tpl',
      1 => 1370525488,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18259216351b0906be91559-27158118',
  'function' => 
  array (
  ),
...
/index.php?file=home-dashboard">Dashboard</a></li>
		<li>/</li>
		<li><a href="<?php echo $_smarty_tpl->getVariable('admin_url')->value;?>
/index.php?file=con-contests&mode=view">Contest</a></li>
		<li>/</li>
		<li class="current"><?php if ($_smarty_tpl->getVariable('mode')->value=='add'){?>Add Contest<?php }else{ ?>Edit Contest<?php }?></li>
	</ul>
</div>
<div id="content">
	<div class="container" id="tabs">
		<div class="conthead">
			...
			<h2 class="left">Add Contest</h2>
			<?php }else{ ?>
			<h2 class="left">Edit Contest</h2>
			<?php }?>
		</div>
	</div>
	<div class="contentbox" style="padding:0 !important">
		<form id="frmadd" name="frmadd" action="index.php?file=con-contests_a" enctype="multipart/form-data" method="post">
			<input type="hidden" name="iContestId" id="iContestId" value="<?php echo $_smarty_tpl->getVariable('iContestId')->value;?>
" />
	...
	<div class="container">
			...
			<div class="contentbox">
				<div class="inputboxes">
					...
					<input type="text" id="vContestName" name="Data[vContestName]" class="inputbox" lang="*" title="Contest Name" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['vContestName'];?>
"/>
				</div>
...
delete.png" onclick="ImageDelete();"/>
						<div style="display:none;">
							<div id="view1">
								<div class="popup_box">
									<div><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value["tsite_upload_images_contests"];?>
/<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iContestId'];?>
...
" /></div>
				...
				<div class="inputboxes">
					...
					<select multiple name="iInterestId[]" id="iInterestId" title="Interest" lang="*" style="width:227px;">
...
"/>
				...
				<div class="inputboxes">
					...
					<select multiple name="iSkillId[]" id="iSkillId" title="Skill" lang="*" style="width:227px;">
...
' <?php if ($_smarty_tpl->getVariable('db_con')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iCountryId']==$_smarty_tpl->getVariable('db_postcampaign')->value[0]['iCountryId']){?>selected<?php }?>><?php echo $_smarty_tpl->getVariable('db_con')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vCountry'];?>
				...
				<div class="inputboxes">
					...
					<input type="text" id="vCity" name="Data[vCity]" class="inputbox" lang="*" title="Your City" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['vCity'];?>
"/>
				</div>
				<div class="inputboxes">
...
" onkeypress="return checkprice(event);"/>
				...
				<div class="inputboxes">
					...
					<input type="text" id="vMileRadius" name="Data[vMileRadius]" class="inputbox" title="Mile Radius" lang="*" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['vMileRadius'];?>
" onkeypress="return checkprice(event);"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Is this a local community ?:</strong></label>
				...
				<div class="inputboxes">
					<label for="textfield"><strong>Is this a National community ?:</strong></label>
				...
				<div class="inputboxes">
					...
					<input type="text" id="dStartDate" name="Data[dStartDate]" class="inputbox" title="Campaign Start Date" lang="*" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['dStartDate'];?>
"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Ad Finish Date:</strong></label>
					<input type="text" id="dFinishDate" name="Data[dFinishDate]" class="inputbox" title="Ad Finish Date"  value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['dFinishDate'];?>
"/>
				</div>
				<div class="inputboxes">
...
/dewplayer.swf" />
								<param name="flashvars" value="mp3=<?php echo $_smarty_tpl->getVariable('tconfig')->value["tsite_upload_images_contests"];?>
/<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iContestId'];?>
...
delete.png" onclick="Mp3Delete();"/></p>
				...
				<div class="inputboxes">
					...
					<input type="text" id="iPointsListenAd" name="Data[iPointsListenAd]" class="inputbox" title="Ponts to Listen To radio ad"  value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iPointsListenAd'];?>
" onkeypress="return checkprice(event);"/>
				</div>
...
/player.swf">
							<input type="hidden" id="videoUrl" value="<?php echo $_smarty_tpl->getVariable('tconfig')->value["tsite_upload_images_contests"];?>
/<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iContestId'];?>
...
delete.png" onclick="videoDelete();"/></p>
				...
				<div class="inputboxes">
					...
					<input type="text" id="iPointsCommercialAd" name="Data[iPointsCommercialAd]" class="inputbox" title="Ponts to view Commercial ad" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iPointsCommercialAd'];?>
" onkeypress="return checkprice(event);"/>
				</div>
			</div>
		</div>
...
<div class="container">
			...
			<div class="contentbox">
				<div class="inputboxes">
					...
					<input type="text" id="vURL" name="Data[vURL]" class="inputbox" title="Ad URL" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['vURL'];?>
"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Ponts to visit This memeber site:</strong></label>
					<input type="text" id="iPointsWeblinkAd" name="Data[iPointsWeblinkAd]" class="inputbox" title="Ponts to visit This memeber site" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iPointsWeblinkAd'];?>
" onkeypress="return checkprice(event);"/>
				</div>
			</div>
		</div>
<div class="container">
			...
			<div class="contentbox">
				<div class="inputboxes">
					...
					<input type="text" id="vBuyLinkURL" name="Data[vBuyLinkURL]" class="inputbox" title="Buy Link URL" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['vBuyLinkURL'];?>
"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Item cost:</strong></label>
					<input type="text" id="iItemCost" name="Data[iItemCost]" class="inputbox" title="Item Cost" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iItemCost'];?>
" onkeypress="return checkprice(event);"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Discount:</strong></label>
					<input type="text" id="iItemDiscount" name="Data[iItemDiscount]" class="inputbox" title="Item Discount" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iItemDiscount'];?>
" onkeypress="return checkprice(event);"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Ponts When Members buy:</strong></label>
					<input type="text" id="iPontsWhenBuy" name="Data[iPontsWhenBuy]" class="inputbox" title="Points When Members buy" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iPontsWhenBuy'];?>
" onkeypress="return checkprice(event);"/>
				</div>
			</div>
		</div>
...
<div class="container">
			...
			<div class="contentbox">
				...
				<div class="inputboxes">
					<input type="text" id="iPointsWhenShare" name="Data[iPointsWhenShare]" class="inputbox" title="Point when memebers share to their extended network" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iPointsWhenShare'];?>
...
" onkeypress="return checkprice(event);"/>
				...
				<div class="inputboxes">
					...
					<input type="text" id="iMaxAdClicks" name="Data[iMaxAdClicks]" class="inputbox" title="Max Ad Clicks" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[0]['iMaxAdClicks'];?>
" onkeypress="return checkprice(event);"/>
				</div>
				<div class="inputboxes">
				...
				<?php if ($_smarty_tpl->getVariable('mode')->value=='add'){?>
				<input type="submit" value="Add Contest" class="btn" title="Add Contest"  onclick="return validate(document.frmadd);" style="cursor:pointer;margin-left:140px;"/>
				<?php }else{ ?>
				<input type="submit" value="Edit Contest" class="btn" title="Edit Contest" onclick="return validate(document.frmadd);" style="cursor:pointer;margin-left:140px;"/>
				<?php }?>
...
/index.php?file=con-contests&mode=view";
    return false;
}
