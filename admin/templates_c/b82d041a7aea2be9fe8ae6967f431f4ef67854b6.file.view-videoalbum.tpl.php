<?php /* Smarty version Smarty-3.0.7, created on 2012-07-12 16:29:59
         compiled from "/var/www/qme_theme/admin/templates/videoalbum/view-videoalbum.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7088949304ffeae2fa7ea15-96141370%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b82d041a7aea2be9fe8ae6967f431f4ef67854b6' => 
    array (
      0 => '/var/www/qme_theme/admin/templates/videoalbum/view-videoalbum.tpl',
      1 => 1342090790,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7088949304ffeae2fa7ea15-96141370',
  'function' => 
  array (
  ),
...
" class="inputbox" /><td>
		...
		<tbody>
        <?php if (count($_smarty_tpl->getVariable('db_videoalbum')->value)>0){?>
...
/index.php?file=va-videoalbum&mode=edit&iVideoAlbumId=<?php echo $_smarty_tpl->getVariable('db_videoalbum')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iVideoAlbumId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_videoalbum')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vVideoAlbum'];?>
</a></td>
			<td><?php echo $_smarty_tpl->getVariable('db_videoalbum')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['eStatus'];?>
</td>
			<td>
...
icons/icon_edit.png" title="Edit" /></a>
				<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_videoalbum')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iVideoAlbumId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_videoalbum')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iVideoAlbumId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_videoalbum')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iVideoAlbumId'];?>
','Delete');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_delete.png" title="Delete" /></a>
			</td>
			
			<td><input name="iVideoAlbumId[]" type="checkbox" id="iId" value="<?php echo $_smarty_tpl->getVariable('db_videoalbum')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iVideoAlbumId'];?>
"/></td>
		</tr>
        <?php endfor; endif; ?>
        <?php }else{ ?>
