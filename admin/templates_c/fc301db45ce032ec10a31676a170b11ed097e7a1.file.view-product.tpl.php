<?php /* Smarty version Smarty-3.0.7, created on 2012-06-13 14:09:05
         compiled from "/var/www/quotation/admin/templates/product/view-product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3550410634fd851aa007666-68222520%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc301db45ce032ec10a31676a170b11ed097e7a1' => 
    array (
      0 => '/var/www/quotation/admin/templates/product/view-product.tpl',
      1 => 1339576723,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3550410634fd851aa007666-68222520',
  'function' => 
  array (
  ),
...
" class="inputbox" /><td>
				<td width="10%" >
					<select name="option" id="option">
						<option value="vTitle">Name</option>
				...
				<td width="10%"><input type="button" value="Add New" onclick="Redirect('index.php?file=pr-product&mode=add');" class="btnalt" /></td>
			</tr>	
			<tr>
        ...
        <form name="frmlist" id="frmlist"  action="index.php?file=pr-product_a" method="post">
		...
		<tbody>
        <?php if (count($_smarty_tpl->getVariable('db_product')->value)>0){?>
		<?php unset($_smarty_tpl->tpl_vars['smarty']->value['section']['i']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['name'] = 'i';
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('db_product')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
/index.php?file=pr-product&mode=edit&iProductId=<?php echo $_smarty_tpl->getVariable('db_product')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iProductId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_product')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vTitle'];?>
</a></td>
			
			<td><?php echo $_smarty_tpl->getVariable('db_product')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['fPrice'];?>
</td>
			<td><?php echo $_smarty_tpl->getVariable('db_product')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['eStatus'];?>
</td>
			<td>
...
icons/icon_edit.png" title="Edit" /></a>
				<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_product')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iProductId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_product')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iProductId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_product')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iProductId'];?>
','Deletes');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_delete.png" title="Delete" /></a>
			</td>
			
			<td><input name="iProductId[]" type="checkbox" id="iId" value="<?php echo $_smarty_tpl->getVariable('db_product')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iProductId'];?>
"/></td>
		</tr>
        <?php endfor; endif; ?>
        <?php }else{ ?>
...
icons/icon_delete.png" alt="Delete" /> Remove</li>
			...
			<div class="bulkactions">
				...
				<input type="submit" value="Apply" class="btn" onclick="return Doaction(document.getElementById('newaction').value,'pr-product',document.frmlist);"/>
			</div>
		</div>
        <div>
