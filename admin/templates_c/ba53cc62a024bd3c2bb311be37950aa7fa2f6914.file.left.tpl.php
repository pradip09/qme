<?php /* Smarty version Smarty-3.0.7, created on 2013-06-06 08:33:52
         compiled from "/home/qmemedia/public_html/admin/templates/left.tpl" */ ?>
<?php /*%%SmartyHeaderCode:111588081551b08fc0f1a389-73887379%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ba53cc62a024bd3c2bb311be37950aa7fa2f6914' => 
    array (
      0 => '/home/qmemedia/public_html/admin/templates/left.tpl',
      1 => 1370525463,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '111588081551b08fc0f1a389-73887379',
  'function' => 
  array (
  ),
...
/index.php?file=pc-postcampaign&mode=view"  title="">Post Campaign</a></li>
		...
		<a class="collapsed heading">Contests</a>
                    <ul class="navigation">
			<?php if ($_GET['file']=='con-contests'){?>
			<li class="heading selected">Contests</li>
			<?php }else{ ?>
			<li class="heading"><a href="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_url'];?>
/index.php?file=con-contests&mode=view"  title="">Contests</a></li>
			<?php }?>
                    </ul>
                </li>
...
/index.php?file=fu-fundraiser&mode=view"  title="">Fundraiser Campaign</a></li>
		...
		<ul class="navigation">
			...
			<?php }else{ ?>
			<li class="heading"><a href="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_url'];?>
/index.php?file=n-news&mode=view"  title="">Relevent News</a></li>
			<?php }?>
			<?php if ($_GET['file']=='n-distictnews'){?>
			<li class="heading selected">Distict News</li>
			<?php }else{ ?>
			<li class="heading"><a href="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_url'];?>
/index.php?file=n-distictnews&mode=edit"  title="">Distict News</a></li>
			<?php }?>
                        <?php if ($_GET['file']=='n-citynews'){?>
			<li class="heading selected">City News</li>
			<?php }else{ ?>
			<li class="heading"><a href="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_url'];?>
/index.php?file=n-citynews&mode=edit"  title="">City News</a></li>
			<?php }?>
		</ul>
		...
		<ul class="navigation">
			<?php if ($_GET['file']=='fan-faq_nfl'){?>
			<li class="heading selected">FAQs</li>
			<?php }else{ ?>
			<li class="heading"><a href="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_url'];?>
/index.php?file=fan-faq_nfl&mode=view"  title="">FAQs</a></li>
			<?php }?>
			<?php if ($_GET['file']=='fan-faqcat_nfl'){?>
			<li class="heading selected">FAQ Category</li>
			<?php }else{ ?>
			<li class="heading"><a href="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_url'];?>
/index.php?file=fan-faqcat_nfl&mode=view" title="">FAQ Category</a></li>
			<?php }?>
                        <?php if ($_GET['file']=='ne-news_nfl'){?>
			<li class="heading selected">News</li>
			<?php }else{ ?>
			<li class="heading"><a href="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_url'];?>
/index.php?file=ne-news_nfl&mode=view"  title="">News</a></li>
			<?php }?>
		</ul>
...
/index.php?file=to-banner&mode=view"  title="">Banner List</a></li>
			<?php }?>
                        <?php if ($_GET['file']=='to-agencybanner'){?>
			<li class="heading selected">Agency Banner List</li>
			<?php }else{ ?>
			<li class="heading"><a href="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_url'];?>
/index.php?file=to-agencybanner&mode=view"  title="">Agency Banner List</a></li>
			<?php }?>
                        <?php if ($_GET['file']=='to-hometab'){?>
			<li class="heading selected">Home Tab</li>
			<?php }else{ ?>
			<li class="heading"><a href="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_url'];?>
/index.php?file=to-hometab&mode=view"  title="">Home Tab</a></li>
			<?php }?>
