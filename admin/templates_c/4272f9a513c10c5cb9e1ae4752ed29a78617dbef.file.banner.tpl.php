<?php /* Smarty version Smarty-3.0.7, created on 2012-06-11 17:34:40
         compiled from "/var/www/quotation/admin/templates/tools/banner.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21231630204fd5ded84c1ee0-49043399%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4272f9a513c10c5cb9e1ae4752ed29a78617dbef' => 
    array (
      0 => '/var/www/quotation/admin/templates/tools/banner.tpl',
      1 => 1339416279,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21231630204fd5ded84c1ee0-49043399',
  'function' => 
  array (
  ),
...
"/>
				...
				<p id="imageid" style="display:none;">
				<div style="width:1000px; display:block;">
				<div  id="imageid">
				<div id="textimage" style="width:332px; float:left;">
					<label for="textfield"><strong>Image :</strong></label>
					<!--<input type="file" id="vImage" name="vImage" class="inputbox" value="<?php echo $_smarty_tpl->getVariable('db_banner')->value[0]['vImage'];?>
...
"/></div>
					...
					<?php }?>
                                  ...
                                  <p id="customid" style="display:none;">
					<label for="textfield"><strong>Custom Code:</strong></label>
					<div id="textcustom"></div>
					<!--<textarea id="tCustomCode" name="Data[tCustomCode]" COLS=50 ROWS=10  title="Custom Code"><?php echo $_smarty_tpl->getVariable('db_banner')->value[0]['tCustomCode'];?>
</textarea>-->
				</p>
