<?php /* Smarty version Smarty-3.0.7, created on 2012-07-18 15:38:39
         compiled from "/var/www/qme_theme/admin/templates/postjob/view-postjob.tpl" */ ?>
<?php /*%%SmartyHeaderCode:212197894250068b279af4e9-97565981%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b73d5c06e57cf74f741b0a62e5a6601b06bc5215' => 
    array (
      0 => '/var/www/qme_theme/admin/templates/postjob/view-postjob.tpl',
      1 => 1342605902,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '212197894250068b279af4e9-97565981',
  'function' => 
  array (
  ),
...
" class="inputbox" /><td>
				...
				<td width="10%"><input type="button" value="Add New" onclick="Redirect('index.php?file=pj-postjob&mode=add');" class="btn" /></td>
			</tr>	
			<tr>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('db_postjob')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
/index.php?file=pj-postjob&mode=edit&iPostJobId=<?php echo $_smarty_tpl->getVariable('db_postjob')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPostJobId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_postjob')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vSkill'];?>
</a></td>
				<td><?php echo $_smarty_tpl->getVariable('db_postjob')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vFirstName'];?>
 <?php echo $_smarty_tpl->getVariable('db_postjob')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vLastName'];?>
</td>
				<td><?php echo $_smarty_tpl->getVariable('db_postjob')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['eStatus'];?>
</td>
				<td>
...
icons/icon_edit.png" title="Edit" /></a>
					<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_postjob')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPostJobId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
					<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_postjob')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPostJobId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>
					<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_postjob')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPostJobId'];?>
','Deletes');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_delete.png" title="Delete" /></a>
				</td>
				<td><input name="iPostJobId[]" type="checkbox" id="iId" value="<?php echo $_smarty_tpl->getVariable('db_postjob')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPostJobId'];?>
"/></td>
			</tr>
		<?php endfor; endif; ?>
		<?php }else{ ?>
