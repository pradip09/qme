<?php /* Smarty version Smarty-3.0.7, created on 2012-12-31 03:02:36
         compiled from "/home/qmemedia/public_html/admin/templates/store/view-store.tpl" */ ?>
<?php /*%%SmartyHeaderCode:186388047850e154ac378fd5-49004817%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1d2a16b513fb5e11b9b4e4015424a47c6a89533' => 
    array (
      0 => '/home/qmemedia/public_html/admin/templates/store/view-store.tpl',
      1 => 1356511752,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '186388047850e154ac378fd5-49004817',
  'function' => 
  array (
  ),
...
" class="inputbox" /></div><td>
				<td width="10%" ><div class="bulkactions">
					<select name="option" id="option">
						<option value="vStoreCategory">Store Category</option>
        ...
        <input  type="hidden" name="iStoreCategoryId" value=""/>
        <thead>
			<tr>
		...
		<tbody>
	<?php if (count($_smarty_tpl->getVariable('db_store')->value)>0){?>
		<?php unset($_smarty_tpl->tpl_vars['smarty']->value['section']['i']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['name'] = 'i';
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('db_store')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
/index.php?file=st-store&mode=edit&iStoreCategoryId=<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iStoreCategoryId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vStoreCategory'];?>
</a></td>
			<!--<td><?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['Name'];?>
</td>-->
			<td><?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['eStatus'];?>
</td>
			<td>
...
icons/icon_edit.png" title="Edit" /></a>
				<!--<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iStoreCategoryId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iStoreCategoryId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iStoreCategoryId'];?>
','Delete');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_delete.png" title="Delete" /></a>-->
			</td>
			
			<td><input name="iStoreCategoryId[]" type="checkbox" id="iId" value="<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iStoreCategoryId'];?>
"/></td>
		</tr>
        <?php endfor; endif; ?>
        <?php }else{ ?>
...
function MakeAction(loopid,type){
    document.frmlist.iStoreCategoryId.value = loopid;
