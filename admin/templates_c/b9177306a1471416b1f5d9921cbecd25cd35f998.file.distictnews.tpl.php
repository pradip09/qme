<?php /* Smarty version Smarty-3.0.7, created on 2013-02-06 08:56:47
         compiled from "/home/qmemedia/public_html/admin/templates/news/distictnews.tpl" */ ?>
<?php /*%%SmartyHeaderCode:138012528551126f2f944614-86666977%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b9177306a1471416b1f5d9921cbecd25cd35f998' => 
    array (
      0 => '/home/qmemedia/public_html/admin/templates/news/distictnews.tpl',
      1 => 1360162602,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '138012528551126f2f944614-86666977',
  'function' => 
  array (
  ),
...
?>
                                                        ...
                                                        <div style="width:200px; float:left;padding:5px;">
                                                          <?php }?>
                                                        <input type="checkbox" id="iDistictId[]" name="iDistictId[]" value="<?php echo $_smarty_tpl->getVariable('db_member')->value[$_smarty_tpl->getVariable('smarty')->value['section']['j']['index']]['iMemberId'];?>
" <?php if (in_array($_smarty_tpl->getVariable('db_member')->value[$_smarty_tpl->getVariable('smarty')->value['section']['j']['index']]['iMemberId'],$_smarty_tpl->getVariable('DistArray')->value)){?>checked="checked"<?php }?>  lang="*" title="checkbox" /><?php echo $_smarty_tpl->getVariable('db_member')->value[$_smarty_tpl->getVariable('smarty')->value['section']['j']['index']]['vName'];?>
<br />
                                                        <?php endfor; endif; ?>                                                            
                                                </div>
                    	</div>
