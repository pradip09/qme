<?php /* Smarty version Smarty-3.0.7, created on 2012-07-16 12:21:19
         compiled from "/var/www/qme_theme/admin/templates/photo/view-photocategory.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1817086535003b9e74c4a17-38273264%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '925392ade2b3305411d33ee9e0ac19add2696684' => 
    array (
      0 => '/var/www/qme_theme/admin/templates/photo/view-photocategory.tpl',
      1 => 1342421477,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1817086535003b9e74c4a17-38273264',
  'function' => 
  array (
  ),
...
" class="inputbox" /><td>
		...
		<tbody>
        <?php if (count($_smarty_tpl->getVariable('db_photocategory')->value)>0){?>
		<?php unset($_smarty_tpl->tpl_vars['smarty']->value['section']['i']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['name'] = 'i';
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('db_photocategory')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
/index.php?file=ph-photocategory&mode=edit&iPhotoCategoryId=<?php echo $_smarty_tpl->getVariable('db_photocategory')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPhotoCategoryId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_photocategory')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vPhotoCategory'];?>
</a></td>
			<td><?php echo $_smarty_tpl->getVariable('db_photocategory')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['eStatus'];?>
</td>
			<td>
...
icons/icon_edit.png" title="Edit" /></a>
				<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_photocategory')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPhotoCategoryId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
				<a href="javas cript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_photocategory')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPhotoCategoryId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_photocategory')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPhotoCategoryId'];?>
','Delete');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_delete.png" title="Delete" /></a>
			</td>
			
			<td><input name="iPhotoCategoryId[]" type="checkbox" id="iId" value="<?php echo $_smarty_tpl->getVariable('db_photocategory')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPhotoCategoryId'];?>
"/></td>
		</tr>
        <?php endfor; endif; ?>
        <?php }else{ ?>
