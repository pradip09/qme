<?php /* Smarty version Smarty-3.0.7, created on 2013-04-29 10:22:29
         compiled from "/home/qmemedia/public_html/admin/templates/news_nfl/view-news_nfl.tpl" */ ?>
<?php /*%%SmartyHeaderCode:824147249517e9035b6ea85-75841404%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '78871410a5fa9020b2fbdf5117a5c6333341875c' => 
    array (
      0 => '/home/qmemedia/public_html/admin/templates/news_nfl/view-news_nfl.tpl',
      1 => 1367248028,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '824147249517e9035b6ea85-75841404',
  'function' => 
  array (
  ),
...
" id="type" name="type"><input type="button" value="Search" class="btn" id="Search" name="Search" title="Search" onclick="Searchoption();"/></div></td>
				<td width="10%"><div class="bulkactions">
				<input type="button" value="Add New" onclick="Redirect('index.php?file=ne-news_nfl&mode=add');" class="btn" /></div>
				</td>
			</tr>	
			<tr>
        ...
        <form name="frmlist" id="frmlist"  action="index.php?file=ne-news_nfl_a" method="post">
...
/index.php?file=ne-news_nfl&mode=edit&iNewsId=<?php echo $_smarty_tpl->getVariable('db_news')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iNewsId'];?>
...
" />
		...
		<div class="extrabottom">
			...
			<td><div class="bulkactions">
				...
				<input type="submit" value="Apply" class="btn" onclick="return Doaction(document.getElementById('newaction').value,'ne-news_nfl',document.frmlist);"/>
			</div></td>
				<td><div>
