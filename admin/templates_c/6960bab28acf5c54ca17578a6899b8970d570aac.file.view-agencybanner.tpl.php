<?php /* Smarty version Smarty-3.0.7, created on 2013-02-13 07:00:46
         compiled from "/home/qmemedia/public_html/admin/templates/tools/view-agencybanner.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1202153330511b8e7ed133b1-79380078%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6960bab28acf5c54ca17578a6899b8970d570aac' => 
    array (
      0 => '/home/qmemedia/public_html/admin/templates/tools/view-agencybanner.tpl',
      1 => 1360760209,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1202153330511b8e7ed133b1-79380078',
  'function' => 
  array (
  ),
...
" class="inputbox" /></div><td>
		...
		<tbody>
        <?php if (count($_smarty_tpl->getVariable('db_agn_banner')->value)>0){?>
		<?php unset($_smarty_tpl->tpl_vars['smarty']->value['section']['i']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['name'] = 'i';
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('db_agn_banner')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
/index.php?file=to-agencybanner&mode=edit&iAgencybannerId=<?php echo $_smarty_tpl->getVariable('db_agn_banner')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iAgencybannerId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_agn_banner')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vTitle'];?>
</a></td>
			<td><?php echo $_smarty_tpl->getVariable('db_agn_banner')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['tOrderNo'];?>
</td>
			<td><?php echo $_smarty_tpl->getVariable('db_agn_banner')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['eStatus'];?>
</td>
			<td>
...
icons/icon_edit.png" title="Edit" /></a>
				<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_agn_banner')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iAgencybannerId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_agn_banner')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iAgencybannerId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_agn_banner')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iAgencybannerId'];?>
','Delete');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_delete.png" title="Delete" /></a>
			</td>
			<td><input name="iAgencybannerId[]" type="checkbox" id="iId" value="<?php echo $_smarty_tpl->getVariable('db_agn_banner')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iAgencybannerId'];?>
"/></td>
		</tr>
        <?php endfor; endif; ?>
        <?php }else{ ?>
