<?php /* Smarty version Smarty-3.0.7, created on 2012-07-14 11:34:55
         compiled from "/var/www/qme_theme/admin/templates/photo/view-photo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:156785136350010c079617f4-95424984%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '43d352cce7135b34b28618681e71c003d6cd6f50' => 
    array (
      0 => '/var/www/qme_theme/admin/templates/photo/view-photo.tpl',
      1 => 1342192242,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '156785136350010c079617f4-95424984',
  'function' => 
  array (
  ),
...
" class="inputbox" /><td>
	...
	<input type="hidden" name="action" id="action" value="" />
		...
		<tbody>
        <?php if (count($_smarty_tpl->getVariable('db_photo')->value)>0){?>
		<?php unset($_smarty_tpl->tpl_vars['smarty']->value['section']['i']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['name'] = 'i';
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('db_photo')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
/index.php?file=ph-photo&mode=edit&iPhotoId=<?php echo $_smarty_tpl->getVariable('db_photo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPhotoId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_photo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vPhotoTitle'];?>
</a></td>
			<td><?php echo $_smarty_tpl->getVariable('db_photo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['PhotoCategory'];?>
</td>
			<td><?php echo $_smarty_tpl->getVariable('db_photo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['Name'];?>
</td>
			<td><?php echo $_smarty_tpl->getVariable('db_photo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['eStatus'];?>
</td>
			<td>
...
icons/icon_edit.png" title="Edit" /></a>
				<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_photo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPhotoId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_photo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPhotoId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_photo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPhotoId'];?>
','Delete');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_delete.png" title="Delete" /></a>
			</td>
			
			<td><input name="iPhotoId[]" type="checkbox" id="iId" value="<?php echo $_smarty_tpl->getVariable('db_photo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPhotoId'];?>
"/></td>
		</tr>
        <?php endfor; endif; ?>
        <?php }else{ ?>
