<?php /* Smarty version Smarty-3.0.7, created on 2012-07-12 17:57:56
         compiled from "/var/www/qme_theme/admin/templates/store/view-store.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11331807714ffec2cc9d5318-23271195%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '866dfd714dc5bee6b409ebe20b074857d1f3a517' => 
    array (
      0 => '/var/www/qme_theme/admin/templates/store/view-store.tpl',
      1 => 1342096074,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11331807714ffec2cc9d5318-23271195',
  'function' => 
  array (
  ),
...
/index.php?file=st-store&mode=edit&iItemId=<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iItemId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vItemName'];?>
</a></td>
...
/index.php?file=so-song&mode=edit&iSongId=<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iItemId'];?>
" title=""><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_edit.png" title="Edit" /></a>
				<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iItemId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iItemId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iItemId'];?>
','Delete');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_delete.png" title="Delete" /></a>
			</td>
			
			<td><input name="iItemId[]" type="checkbox" id="iId" value="<?php echo $_smarty_tpl->getVariable('db_store')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iItemId'];?>
"/></td>
		</tr>
        <?php endfor; endif; ?>
        <?php }else{ ?>
