<?php /* Smarty version Smarty-3.0.7, created on 2012-07-12 18:13:45
         compiled from "/var/www/qme_theme/admin/templates/tools/view-staticpage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6502614864ffec681085e26-85608815%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cdaae2491f02151bac98c9047d164690a556d5dc' => 
    array (
      0 => '/var/www/qme_theme/admin/templates/tools/view-staticpage.tpl',
      1 => 1342097022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6502614864ffec681085e26-85608815',
  'function' => 
  array (
  ),
...
" id="type" name="type"><input type="button" value="Search" class="btn" id="Search" name="Search" title="Search" onclick="Searchoption();"/></td>
				<td width="10%"><input type="button" value="Add New" onclick="Redirect('index.php?file=to-staticpage&mode=add');" class="btn" /></td>
...
icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_static_pages')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPageId'];?>
