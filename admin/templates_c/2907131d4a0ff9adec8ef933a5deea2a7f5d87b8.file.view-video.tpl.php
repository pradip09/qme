<?php /* Smarty version Smarty-3.0.7, created on 2012-07-13 10:22:50
         compiled from "/var/www/qme_theme/admin/templates/video/view-video.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8263614854fffa9a25a3eb3-46907062%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2907131d4a0ff9adec8ef933a5deea2a7f5d87b8' => 
    array (
      0 => '/var/www/qme_theme/admin/templates/video/view-video.tpl',
      1 => 1342091691,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8263614854fffa9a25a3eb3-46907062',
  'function' => 
  array (
  ),
...
" class="inputbox" /><td>
				<td width="10%" >
					<select name="option" id="option">
						<option value="vVideoName">Video Name</option>
						<option value="v.eStatus">Status</option>
					</select>
				</td>
				<td width="60%"><input type="button" value="Search" class="btn" id="Search" name="Search" title="Search" onclick="Searchoption();"/></td>
				<td width="10%"><input type="button" value="Add New" onclick="Redirect('index.php?file=v-video&mode=add');" class="btn" /></td>
			</tr>	
			<tr>
        ...
        <form name="frmlist" id="frmlist"  action="index.php?file=v-video_a" method="post">
...
/index.php?file=v-video&mode=edit&iVideoId=<?php echo $_smarty_tpl->getVariable('db_video')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iVideoId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_video')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vVideoName'];?>
</a></td>
			<td><?php echo $_smarty_tpl->getVariable('db_video')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['VideoAlbum'];?>
</td>
			<td><?php echo $_smarty_tpl->getVariable('db_video')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['Name'];?>
</td>
...
icons/icon_edit.png" title="Edit" /></a>
				<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_video')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iVideoId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_video')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iVideoId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_video')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iVideoId'];?>
...
function MakeAction(loopid,type){
    document.frmlist.iVideoId.value = loopid;
