<?php /* Smarty version Smarty-3.0.7, created on 2013-06-06 08:36:39
         compiled from "/home/qmemedia/public_html/admin/templates/contests/view-contests.tpl" */ ?>
<?php /*%%SmartyHeaderCode:41521910151b0906741a8a2-17826575%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b97dc88c6813c7a5c22119f48f56ce4a3aad6fdb' => 
    array (
      0 => '/home/qmemedia/public_html/admin/templates/contests/view-contests.tpl',
      1 => 1370525487,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '41521910151b0906741a8a2-17826575',
  'function' => 
  array (
  ),
...
" class="inputbox" /></div><td>
				<td width="10%"><div class="bulkactions">
					<select name="option" id="option">
						<option  value='vContestName'>Contest Name</option>
				...
				<td width="10%"><div class="bulkactions"><input type="button" value="Add New" onclick="Redirect('index.php?file=con-contests&mode=add');" class="btn" /></div></td>
			</tr>	
			<tr>
		...
		<form name="frmlist" id="frmlist"  action="index.php?file=con-contests_a" method="post">
		<div class="administator_table">
			<table width="100%" border="0">
			<input type="hidden" name="action" id="action" value="" />
		<input  type="hidden" name="iContestId" value=""/>
		<thead>
				<tr>
					<th>Contest Name</th>
					<th>City</th>
...
/index.php?file=con-contests&mode=edit&iContestId=<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iContestId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vContestName'];?>
</a></td>
 ...
 <?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vLastName'];?>
				...
				<td><?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vCity'];?>
</td>
				<td><?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vZipCode'];?>
</td>
...
icons/icon_edit.png" title="Edit" /></a>
					<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iContestId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
					<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iContestId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>
					<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iContestId'];?>
','Deletes');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_delete.png" title="Delete" /></a>
				</td>
				<td><input name="iContestId[]" type="checkbox" id="iId" value="<?php echo $_smarty_tpl->getVariable('db_postcampaign')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iContestId'];?>
"/></td>
			</tr>
		<?php endfor; endif; ?>
		<?php }else{ ?>
		...
		<div class="extrabottom">
			...
			<td><div class="bulkactions">
				...
				<input type="submit" value="Apply" class="btn" onclick="return Doaction(document.getElementById('newaction').value,'con-contests',document.frmlist);"/>
			</div></td>
				<td><div>
	...
	function AlphaSearch(val){
	    var alphavalue = val;
	    var file = 'con-contests';
	    window.location="index.php?file="+file+"&alp="+alphavalue+"&mode=view";
	    return false;
	}
	function MakeAction(loopid,type){
	    document.frmlist.iContestId.value = loopid;
