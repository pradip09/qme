<?php /* Smarty version Smarty-3.0.7, created on 2012-12-31 03:02:28
         compiled from "/home/qmemedia/public_html/admin/templates/storeplan/view-storeplan.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19667328650e154a4ad04d4-01712777%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd6d3b5d8e35a970ecfcd4fda5f139432f21d7526' => 
    array (
      0 => '/home/qmemedia/public_html/admin/templates/storeplan/view-storeplan.tpl',
      1 => 1356511675,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19667328650e154a4ad04d4-01712777',
  'function' => 
  array (
  ),
...
" class="inputbox" /></div><td>
		...
		<tbody>
	<?php if (count($_smarty_tpl->getVariable('db_storeplan')->value)>0){?>
		<?php unset($_smarty_tpl->tpl_vars['smarty']->value['section']['i']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['name'] = 'i';
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('db_storeplan')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
/index.php?file=sp-storeplan&mode=edit&iStorePlanId=<?php echo $_smarty_tpl->getVariable('db_storeplan')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iStorePlanId'];?>
" title=""><?php echo $_smarty_tpl->getVariable('db_storeplan')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['vStorePlanName'];?>
</a></td>
			<td><?php echo $_smarty_tpl->getVariable('db_storeplan')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iPoint'];?>
</td>
			 <td><?php echo $_smarty_tpl->getVariable('db_storeplan')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['fPrice'];?>
</td>
			<td><?php echo $_smarty_tpl->getVariable('db_storeplan')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['eStatus'];?>
</td>
			<td>
...
icons/icon_edit.png" title="Edit" /></a>
				...
				<!--<a href="javascript:void(0);" title="Active" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_storeplan')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iStorePlanId'];?>
','Active');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_storeplan')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iStorePlanId'];?>
','Inactive');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_unapprove.png" title="Inactive" /></a>-->
				<!--<a href="javascript:void(0);" title="Delete" onclick="MakeAction('<?php echo $_smarty_tpl->getVariable('db_storeplan')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iStorePlanId'];?>
','Delete');"><img src="<?php echo $_smarty_tpl->getVariable('tconfig')->value['tpanel_img'];?>
icons/icon_delete.png" title="Delete" /></a>-->
			
			
			<td><input name="iStorePlanId[]" type="checkbox" id="iId" value="<?php echo $_smarty_tpl->getVariable('db_storeplan')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['iStorePlanId'];?>
"/></td>
		</tr>
        <?php endfor; endif; ?>
        <?php }else{ ?>
