<?php /* Smarty version Smarty-3.0.7, created on 2012-07-14 11:25:34
         compiled from "/var/www/qme_theme/admin/templates/news/news.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2017032693500109d64ccdc8-87379426%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f0a588b86b8e947efb80975fe69a8c09e48046c3' => 
    array (
      0 => '/var/www/qme_theme/admin/templates/news/news.tpl',
      1 => 1342245306,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2017032693500109d64ccdc8-87379426',
  'function' => 
  array (
  ),
				...
				<div class="inputboxes">
					...
					<select id="eStatus" name="Data[eStatus]">
						...
						<option value="Inactive" <?php if ($_smarty_tpl->getVariable('db_news')->value[0]['eStatus']=='Inactive'){?>selected<?php }?>>Inactive</option>
               			...
               			<?php if ($_smarty_tpl->getVariable('mode')->value=='add'){?>
   				<input type="submit" value="Add News" class="btn" onclick="return validate(document.frmadd);" title="Add News"/>
   				<?php }else{ ?>
   				<input type="submit" value="Edit News" class="btn" onclick="return validate(document.frmadd);" title="Edit News"/>
   				<?php }?>
