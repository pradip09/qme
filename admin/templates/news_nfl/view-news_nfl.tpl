...
<div class="container">
	...
	<div class="administator_table">
        ...
        <tr>
			...
			<td><a href="{$admin_url}/index.php?file=ne-news_nfl&mode=edit&iNewsId={$db_news[i].iNewsId}" title="">{$db_news[i].vTitle}</a></td>
			...
			<td>
				<a href="{$tconfig.tpanel_url}/index.php?file=ne-news_nfl&mode=edit&iNewsId={$db_news[i].iNewsId}" title=""><img src="{$tconfig.tpanel_img}icons/icon_edit.png" title="Edit" /></a>
