...
<div id="breadcrumb">
	<ul>
		...
		<li>/</li>
		<li><a href="{$admin_url}/index.php?file=m-member&mode=view">Member</a></li>
		<li>/</li>
		<li class="current">{if $mode eq 'add'}Add Member{else}Edit Member{/if}</li>
	</ul>
</div>
<div id="content">
	...
	<div id="tabs" style="background:transparent !important; color:#666 !important; border: none !important;">
			...
			<form id="frm" name="frm" action="index.php?file=m-member_a" enctype="multipart/form-data" method="post">			
					...
					<div class="contentbox">
						...
						<div class="inputboxes">
							...
							<select id="eGender" name="Data[eGender]" lang="*" title="Gender" style="width:224px;">
								...
								<option value="Business" {if $db_mem[0].eGender eq Business}selected{/if}>Business</option>
							</select>
						</div>
						<div class="inputboxes">
							...
							<select id="eType" name="Data[eType]" lang="*" title="eType" style="width:224px;">
								...
								<option value="Member" {if $db_mem[0].eType eq Member}selected{/if}>Member</option>
								<option value="Business" {if $db_mem[0].eType eq Business}selected{/if}>Business</option>
								<option value="Sports" {if $db_mem[0].eType eq Sports}selected{/if}>Sports</option>
						...
						<div class="inputboxes">
							...
							<input type="text" name="Data[vCity]" class="inputbox" id="vCity" value="{$db_mem[0].vCity}" title="city" lang="*" />
						</div>
						<div class="inputboxes">
							<label for="textfield"><strong>Address:</strong></label>
							<input type="text" name="Data[vAddress]" class="inputbox" id="vAddress" value="{$db_mem[0].vAddress}" title="address" lang="*"/>
						</div>
						<div class="inputboxes">
							<label for="textfield"><strong>Zip Code:</strong></label>
							<input type="text" name="Data[vZipCode]" class="inputbox" id="vZipCode" value="{$db_mem[0].vZipCode}" title="zip code" onkeypress="return checkmobile(event);" lang="*" />
						</div>
						<div class="inputboxes">
							<label for="textfield"><strong>Phone No:</strong></label>
							<input type="text" name="Data[vPhone]" class="inputbox" id="vPhone" value="{$db_mem[0].vPhone}" title="Phone No" onkeypress="return checkmobile(event);" lang="*" />
						</div>
						<div class="inputboxes">
							<label><strong>Interests:</strong></label>
							<br/>
							{if  $db_interestt|@count gt 0}
							<div class="event_skill">
								{section name=j loop=$db_interestt}
								<div class="event_slikk_inner">
									<input type="checkbox" value="{$db_interestt[j].iInterestId}" id="iInterestId" name="Data[iInterestId][]" {if $db_interestt[j].iInterestId|in_array:$relatedArr}checked{/if} lang="*" title="Interest" />
									{$db_interestt[j].vInterest}
								</div>
								{/section}
							</div>
							{/if}
						...
						<div class="inputboxes">
							...
							<input type="text" name="Data[vOtherInterest]" class="inputbox" id="vOtherInterest" value="{$db_mem[0].vOtherInterest}" title="Other Interest" />
						</div>
						<div class="inputboxes">
							<label><strong>Skills:</strong></label>
							<br/>
							{if  $db_skill1|@count gt 0}
							<div class="event_skill">
								{section name=j loop=$db_skill1}
								<div class="event_slikk_inner">
									<input type="checkbox" value="{$db_skill1[j].iSkillId}" id="iSkillId" name="Data[iSkillId][]" {if $db_skill1[j].iSkillId|in_array:$skillArr}checked{/if} lang="*" title="Skill"/>
									{$db_skill1[j].vSkill}
								</div>
								{/section}
							</div>
				...
				<div class="container half right">
					...
					<div class="contentbox">
						...
						<div class="inputboxes">
							<label for="textfield"><strong>Address:</strong></label>
							<input type="text" id="vBizAddress" name="Data[vBizAddress]" class="inputbox" value="{$db_mem[0].vBizAddress}" lang="*" title="Address"/>
						</div>
						<div class="inputboxes">
							<label for="textfield"><strong>Phone:</strong></label>
							<input type="text" id="vBizPhone"  name="Data[vBizPhone]" class="inputbox" lang="*" title="Phone no"  value="{$db_mem[0].vBizPhone}" onkeypress="return checkmobile(event);"/>
						</div>
						<div class="inputboxes">
							<label for="textfield"><strong>Email Address:</strong></label>
							<input type="text" id="vBizEmail"  name="Data[vBizEmail]" class="inputbox"  lang="{literal}*{E}{/literal}" title="E-mail" value="{$db_mem[0].vBizEmail}"/>
						</div>
						...
						<div class="inputboxes">
							<label for="textfield"><strong>City:</strong></label>
							<input type="text" id="vBizCity" name="Data[vBizCity]" class="inputbox" value="{$db_mem[0].vBizCity}" lang="*" title="City"/>
						</div>
					...
					<div class="contentbox">
						<div style="display:block;">
							<div class="inputboxes">
								...
								{if $db_mem[0].vProfileImage eq ''}
								<input type="file" id="vProfileImage" name="vProfileImage" class="inputbox" value="{$db_mem[0].vProfileImage}"  title=" Profile Image" onchange="CheckValidFile(this.value,this.name)" style="width: 201px;margin-right: 87px;" lang="*"/>
								{else}
								<input type="file" id="vProfileImage" name="vProfileImage" class="inputbox" value="{$db_mem[0].vProfileImage}"  onchange="CheckValidFile(this.value,this.name)" style="width: 201px;margin-right: 87px;" />
								{/if}
		...
		<div id="tab-event" style="padding:0 !important; background:transparent !important; color:#666 !important; border: none !important;"> {include file="events/event.tpl"} </div>
