		...
		<div class="container">
			...
			<div class="contentbox" >
				<div class="inputboxes">
					...
					<input type="text" id="vCampaignName" name="Data[vCampaignName]" class="inputbox" lang="*" title="Ad Name" value="{$db_postcampaign[0].vCampaignName}"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Ad Content</strong></label>
				</div>
				<textarea id="tContent" name="Data[tContent]" class="inputbox" title="Ad Content" style="width:460px; height:90px;">{$db_postcampaign[0].tContent}</textarea>
				<div style="clear:both;"></div>
				<br>
				<div class="inputboxes">
					<label for="textfield"><strong>Ad Image:</strong></label>
					{if $db_postcampaign[0].vImage eq ''}
					<input type="file" id="vImage" name="vImage" class="inputbox" value="{$db_postcampaign[0].vImage}"  title="Ad Image" lang="*" onchange="CheckValidImageFile(this.value,this.id)"/>
					{else}
					<input type="file" id="vImage" name="vImage" class="inputbox" value="{$db_postcampaign[0].vImage}"  title="Ad Image" onchange="CheckValidImageFile(this.value,this.id)"/>
					{/if}
					...
					<div style="float:right; width:167px;">
						...
						<div style="display:none;">
							<div id="view1">
								<div class="popup_box">
									<div><img src="{$tconfig["tsite_upload_images_campaign"]}/member/{$db_postcampaign[0].iMemberId}/{$db_postcampaign[0].vImage}" /></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="inputboxes">
					...
					<select name="Data[iInterestId]" id="iInterestId" title="Campaign Interest" lang="*">
						...
						<option value="{$db_interest[i].iInterestId}" {if $db_interest[i].iInterestId eq $db_postcampaign[0].iInterestId} selected {/if}>{$db_interest[i].vInterest}</option>
				...
				<div class="inputboxes">
					...
					<input type="text" id="vIndustry" name="Data[vIndustry]" class="inputbox" title="Industry" lang="*" value="{$db_postcampaign[0].vIndustry}"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Is this a local community campaign?:</strong></label>
					<label for="textfield">
					<input type="checkbox" id="eIsLocal" name="eIsLocal" value="Yes" {if $db_postcampaign[0].eIsLocal eq Yes}checked{/if}>
				...
				<div class="inputboxes">
					...
					<input type="text" id="vMileRadius" name="Data[vMileRadius]" class="inputbox" title="Zip Code" lang="*" value="{$db_postcampaign[0].vMileRadius}" onkeypress="return checkprice(event);"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Is this a National community campaign?:</strong></label>
					<label for="textfield">
					<input type="checkbox" id="eIsNational" name="eIsNational" value="Yes" {if $db_postcampaign[0].eIsNational eq Yes}checked{/if}>
					<strong>Yes</strong></label>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Ad Start Date:</strong></label>
					<input type="text" id="dStartDate" name="Data[dStartDate]" class="inputbox" title="Ad Start Date" lang="*" value="{$db_postcampaign[0].dStartDate}"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Ad Finish Date:</strong></label>
					<input type="text" id="dFinishDate" name="Data[dFinishDate]" class="inputbox" title="Ad Finish Date" lang="*" value="{$db_postcampaign[0].dFinishDate}"/>
				</div>
				<div class="inputboxes">
			...
			<div class="contentbox">
				<div class="inputboxes">
					<div>
						...
						<input type="file" id="vMp3File" name="vMp3File" class="inputbox" value="{$db_postcampaign[0].vMp3File}"  title="Mp3 File" lang="*" onchange="CheckValidAudioFile(this.value,this.id)"/>
						{else}
						<input type="file" id="vMp3File" name="vMp3File" class="inputbox" value="{$db_postcampaign[0].vMp3File}"  title="Mp3 File" onchange="CheckValidAudioFile(this.value,this.id)"/>
						{/if} </div>
					...
					<div style="float:left; width:450px; margin-top: 15px;">
						<div style="width:260px; float:left; margin-left:135px;">
							<object type="application/x-shockwave-flash" data="{$tconfig['tsite_music']}/dewplayer-bubble.swf" width="250" height="65" id="dewplayer" name="dewplayer">
								...
								<param name="flashvars" value="mp3={$tconfig["tsite_upload_images_campaign"]}/member/{$db_postcampaign[0].iMemberId}/{$db_postcampaign[0].vMp3File}&amp;showtime=1&amp;randomplay=1&amp;nopointer=1" />
							</object>
						</div>
						<div style="width:50px; float:right">
							<p style="margin:10px 0 10px 0;"><img src="{{$tconfig["tsite_images"]}}delete.png" onclick="Mp3Delete();"/></p>
						</div>
					</div>
					{/if} </div>
				<div class="inputboxes">
					<label for="textfield"><strong>Ponts to Listen To radio ad:</strong></label>
					<input type="text" id="iPointsListenAd" name="Data[iPointsListenAd]" class="inputbox" title="Ponts to Listen To radio ad" lang="*" value="{$db_postcampaign[0].iPointsListenAd}" onkeypress="return checkprice(event);"/>
				</div>
			</div>
		</div>
		<div class="container">
			...
			<div class="contentbox">
				<div class="inputboxes">
					<div>
						...
						<input type="file" id="vVideoFile" name="vVideoFile" class="inputbox" value="{$db_postcampaign[0].vVideoFile}"  title="VideoFile" lang="*" onchange="CheckValidVideoFile(this.value,this.id)"/>
						{else}
						<input type="file" id="vVideoFile" name="vVideoFile" class="inputbox" value="{$db_postcampaign[0].vVideoFile}"  title="VideoFile" onchange="CheckValidVideoFile(this.value,this.id)"/>
						{/if} </div>
					...
					<div style="float:left; width:450px; margin-top: 15px;">
						<div id="video-container">Loading the player ...
							...
							<input type="hidden" id="videoUrl" value="{$tconfig["tsite_upload_images_campaign"]}/member/{$db_postcampaign[0].iMemberId}/{$db_postcampaign[0].vVideoFile}">
						</div>
				...
				<div class="inputboxes">
					...
					<input type="text" id="iPointsCommercialAd" name="Data[iPointsCommercialAd]" class="inputbox" title="Ponts to view Commercial ad" lang="*" value="{$db_postcampaign[0].iPointsCommercialAd}" onkeypress="return checkprice(event);"/>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="contentbox">
				<div class="inputboxes">
					...
					<input type="text" id="vURL" name="Data[vURL]" class="inputbox" title="Ad URL" lang="*" value="{$db_postcampaign[0].vURL}"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Ponts to visit This memeber site:</strong></label>
					<input type="text" id="iPointsWeblinkAd" name="Data[iPointsWeblinkAd]" class="inputbox" title="Ponts to visit This memeber site" lang="*" value="{$db_postcampaign[0].iPointsWeblinkAd}" onkeypress="return checkprice(event);"/>
				</div>
			</div>
		</div>
		<div class="container">
			...
			<div class="contentbox">
				<div class="inputboxes">
					...
					<input type="text" id="vBuyLinkURL" name="Data[vBuyLinkURL]" class="inputbox" title="Buy Link URL" lang="*" value="{$db_postcampaign[0].vBuyLinkURL}"/>
				</div>
				<div class="inputboxes">
					<label for="textfield"><strong>Ponts When Members buy:</strong></label>
					<input type="text" id="iPontsWhenBuy" name="Data[iPontsWhenBuy]" class="inputbox" title="Points When Members buy" lang="*" value="{$db_postcampaign[0].iPontsWhenBuy}" onkeypress="return checkprice(event);"/>
				</div>
			</div>
		</div>
		<div class="container">
			...
			<div class="contentbox">
				...
				<div class="inputboxes">
					<input type="text" id="iPointsWhenShare" name="Data[iPointsWhenShare]" class="inputbox" title="Point when memebers share to their extended network" lang="*" value="{$db_postcampaign[0].iPointsWhenShare}" onkeypress="return checkprice(event);"/>
				</div>
			</div>
		</div>
		<div class="container">
		...
		<div class="container">
			...
			<div class="contentbox">
				...
				<div class="inputboxes">
					...
					<input type="text" id="iMaxAdClicks" name="Data[iMaxAdClicks]" class="inputbox" title="Max Ad Clicks" lang="*" value="{$db_postcampaign[0].iMaxAdClicks}" onkeypress="return checkprice(event);"/>
				</div>
				<div class="inputboxes">
...
function redirectcancel(){
    ...
    window.location="{/literal}{$admin_url}{literal}/index.php?file=m-member&mode=edit#tab-postcampaign";
    return false;
}
