...
<div class="container">
	...
	{/if}
		...
		<tr class="{$class}">
				...
				<td><a href="{$tconfig.tpanel_url}/index.php?file=pc-postcampaign&mode=edit&iCampaignId={$db_postcampaign[i].iCampaignId}" title="">{$db_postcampaign[i].vCampaignName}</a></td>
				<td>{$db_postcampaign[i].vFirstName} {$db_postcampaign[i].vLastName}</td>
				<td>{$db_postcampaign[i].eStatus}</td>
				<td>
					<a href="{$tconfig.tpanel_url}/index.php?file=pc-postcampaign&mode=edit&iCampaignId={$db_postcampaign[i].iCampaignId}" title=""><img src="{$tconfig.tpanel_img}icons/icon_edit.png" title="Edit" /></a>
					<a href="javascript:void(0);" title="Active" onclick="MakeAction('{$db_postcampaign[i].iCampaignId}','Active');"><img src="{$tconfig.tpanel_img}icons/icon_approve.png" title="Active" /></a>
					<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('{$db_postcampaign[i].iCampaignId}','Inactive');"><img src="{$tconfig.tpanel_img}icons/icon_unapprove.png" title="Inactive" /></a>
					<a href="javascript:void(0);" title="Delete" onclick="MakeAction('{$db_postcampaign[i].iCampaignId}','Deletes');"><img src="{$tconfig.tpanel_img}icons/icon_delete.png" title="Delete" /></a>
				</td>
				<td><input name="iCampaignId[]" type="checkbox" id="iId" value="{$db_postcampaign[i].iCampaignId}"/></td>
			</tr>
		{/section}
		{else}
		<tr>
