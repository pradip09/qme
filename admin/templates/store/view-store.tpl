...
<div class="container">
	...
	{if $smarty.section.i.index % 2}
        ...
        {/if}
        <tr class="{$class}">
			<td><a href="{$tconfig.tpanel_url}/index.php?file=st-store&mode=edit&iStoreCategoryId={$db_store[i].iStoreCategoryId}" title="">{$db_store[i].vStoreCategory}</a></td>
			<!--<td>{$db_store[i].Name}</td>-->
			<td>{$db_store[i].eStatus}</td>
			<td>
				<a href="{$tconfig.tpanel_url}/index.php?file=st-store&mode=edit&iStoreCategoryId={$db_store[i].iStoreCategoryId}" title=""><img src="{$tconfig.tpanel_img}icons/icon_edit.png" title="Edit" /></a>
				<!--<a href="javascript:void(0);" title="Active" onclick="MakeAction('{$db_store[i].iStoreCategoryId}','Active');"><img src="{$tconfig.tpanel_img}icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('{$db_store[i].iStoreCategoryId}','Inactive');"><img src="{$tconfig.tpanel_img}icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('{$db_store[i].iStoreCategoryId}','Delete');"><img src="{$tconfig.tpanel_img}icons/icon_delete.png" title="Delete" /></a>-->
			</td>
			
			<td><input name="iStoreCategoryId[]" type="checkbox" id="iId" value="{$db_store[i].iStoreCategoryId}"/></td>
		</tr>
        {/section}
        {else}
        <tr>
