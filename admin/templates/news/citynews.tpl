                                 ...
                                 <label for="textfield" style="width:300px;"><strong>Select Member profile:</strong></label><br /><br />  
                                      <hr />                        
                                                <div style="width:200px; float:left; padding:5px;" >
                                                        ...
                                                        <div style="width:200px; float:left;padding:5px;">
                                                          {/if}
                                                        <input type="checkbox" id="iCitynewsId[]" name="iCitynewsId[]" value="{$db_member[j].iMemberId}" {if $db_member[j].iMemberId|@in_array:$CityArray}checked="checked"{/if} lang="*" title="checkbox" />{$db_member[j].vName}<br />
                                                        {/section}                                                            
                                                </div>
                    	</div>
