...
<div id="breadcrumb">
	<ul>
		...
		<li>/</li>
		<li><a href="{$admin_url}/index.php?file=con-contests&mode=view">Contest</a></li>
		<li>/</li>
		<li class="current">{if $mode eq 'add'}Add Contest{else}Edit Contest{/if}</li>
	</ul>
</div>
<div id="content">
	...
	<div class="contentbox" style="padding:0 !important">
		<form id="frmadd" name="frmadd" action="index.php?file=con-contests_a" enctype="multipart/form-data" method="post">
			<input type="hidden" name="iContestId" id="iContestId" value="{$iContestId}" />
	...
	<div class="container">
			...
			<div class="contentbox">
				<div class="inputboxes">
					...
					<input type="text" id="vContestName" name="Data[vContestName]" class="inputbox" lang="*" title="Contest Name" value="{$db_postcampaign[0].vContestName}"/>
				</div>
				...
				<div class="inputboxes">
					...
					<div style="float:right; width:200px;">
						...
						<div style="display:none;">
							<div id="view1">
								<div class="popup_box">
									<div><img src="{$tconfig["tsite_upload_images_contests"]}/{$db_postcampaign[0].iContestId}/{$db_postcampaign[0].vImage}" /></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div style="float:left; width:392px; margin-top: 11px;">
						<div style="width:200px; float:left; margin-left:135px;">
							<object type="application/x-shockwave-flash" data="{$tconfig['tsite_music']}/dewplayer.swf" width="200" height="20" id="dewplayer" name="dewplayer">
								...
								<param name="flashvars" value="mp3={$tconfig["tsite_upload_images_contests"]}/{$db_postcampaign[0].iContestId}/{$db_postcampaign[0].vMp3File}&amp;showtime=1&amp;randomplay=1&amp;nopointer=1" />
							</object>
						</div>
				...
				<div class="inputboxes">
					...
					<div style="float:left; width:450px; margin-top: 15px;">
						<div id="video-container">Loading the player ...
							...
							<input type="hidden" id="videoUrl" value="{$tconfig["tsite_upload_images_contests"]}/{$db_postcampaign[0].iContestId}/{$db_postcampaign[0].vVideoFile}">
						</div>
...
function redirectcancel(){
    ...
    window.location="{/literal}{$admin_url}{literal}/index.php?file=con-contests&mode=view";
    return false;
}
