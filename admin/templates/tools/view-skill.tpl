...
<div class="container">
    ...
    {/if}
        ...
        <tr class="{$class}">
			...
			<td><a href="{$admin_url}/index.php?file=to-skill&mode=edit&iSkillId={$db_skill[i].iSkillId}" title="{$db_skill[i].vSkill}">{$db_skill[i].vSkill}</a></td>
			<td>{$db_skill[i].eStatus}</td>
			
			<td>
				<a href="{$tconfig.tpanel_url}/index.php?file=to-skill&mode=edit&iSkillId={$db_skill[i].iSkillId}" title=""><img src="{$tconfig.tpanel_img}icons/icon_edit.png" title="Edit" /></a>
				<a href="javascript:void(0);" title="Active" onclick="MakeAction('{$db_skill[i].iSkillId}','Active');"><img src="{$tconfig.tpanel_img}icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('{$db_skill[i].iSkillId}','Inactive');"><img src="{$tconfig.tpanel_img}icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('{$db_skill[i].iSkillId}','Delete');"><img src="{$tconfig.tpanel_img}icons/icon_delete.png" title="Delete" /></a>
			</td>
			<td><input name="iSkillId[]" type="checkbox" id="iId" value="{$db_skill[i].iSkillId}"/></td>
		</tr>
        {/section}
        {else}
        <tr>
