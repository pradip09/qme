...
<div id="breadcrumb">
	<ul>
		...
		<li>/</li>
		<li class="current">System Emails</li>
	</ul>
</div>
<div id="content">
<div class="container">
    ...
    {/if}
		...
		<tbody>
        {if $db_system_email|@count gt 0}
		{section name=i loop=$db_system_email}
        ...
        <tr class="{$class}">
			...
			<td><a href="{$admin_url}/index.php?file=to-systememails&mode=edit&iEmailTemplateId={$db_system_email[i].iEmailTemplateId}" title="{$db_system_email[i].vEmailTitle}">{$db_system_email[i].vEmailTitle}</a></td>
			<td>{$db_system_email[i].vEmailCode}</td>
			<td>{$db_system_email[i].vFromName}</td>
			<td>{$db_system_email[i].vFromEmail}</td>
			<td>{$db_system_email[i].eStatus}</td>
			
			<td>
				<a href="{$tconfig.tpanel_url}/index.php?file=to-systememails&mode=edit&iEmailTemplateId={$db_system_email[i].iEmailTemplateId}" title=""><img src="{$tconfig.tpanel_img}icons/icon_edit.png" title="Edit" /></a>
				<a href="javascript:void(0);" title="Active" onclick="MakeAction('{$db_system_email[i].iEmailTemplateId}','Active');"><img src="{$tconfig.tpanel_img}icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('{$db_system_email[i].iEmailTemplateId}','Inactive');"><img src="{$tconfig.tpanel_img}icons/icon_unapprove.png" title="Inactive" /></a>
			</td>
			<td><input name="iEmailTemplateId[]" type="checkbox" id="iId" value="{$db_system_email[i].iEmailTemplateId}"/></td>
		</tr>
        {/section}
        {else}
        <tr>
