...
<div class="container">
    ...
    {/if}
        ...
        {/if}
        <tr class="{$class}">
			<td><a href="{$admin_url}/index.php?file=to-banner&mode=edit&iBannerId={$db_banner[i].iBannerId}" title="">{$db_banner[i].vPage}</a></td>
			<td>{$db_banner[i].eType}</td>
			<td>{$db_banner[i].eStatus}</td>
			<td>
				<a href="{$tconfig.tpanel_url}/index.php?file=to-banner&mode=edit&iBannerId={$db_banner[i].iBannerId}" title=""><img src="{$tconfig.tpanel_img}icons/icon_edit.png" title="Edit" /></a>
				<a href="javascript:void(0);" title="Active" onclick="MakeAction('{$db_banner[i].iBannerId}','Active');"><img src="{$tconfig.tpanel_img}icons/icon_approve.png" title="Active" /></a>
				<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('{$db_banner[i].iBannerId}','Inactive');"><img src="{$tconfig.tpanel_img}icons/icon_unapprove.png" title="Inactive" /></a>
				<a href="javascript:void(0);" title="Delete" onclick="MakeAction('{$db_banner[i].iBannerId}','Delete');"><img src="{$tconfig.tpanel_img}icons/icon_delete.png" title="Delete" /></a>
			</td>
			<td><input name="iBannerId[]" type="checkbox" id="iId" value="{$db_banner[i].iBannerId}"/></td>
		</tr>
        {/section}
        {else}
        <tr>
