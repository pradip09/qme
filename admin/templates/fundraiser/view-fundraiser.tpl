...
<div class="container">
	...
	{/if}
		...
		{if $db_fundcampaign|@count gt 0}
			{section name=i loop=$db_fundcampaign}
		...
		<tr class="{$class}">
				...
				<td><a href="{$tconfig.tpanel_url}/index.php?file=fu-fundraiser&mode=edit&iCampaignId={$db_fundcampaign[i].iCampaignId}" title="">{$db_fundcampaign[i].vCampaignName}</a></td>
				<td>{$db_fundcampaign[i].vName}</td>
				<td>{$db_fundcampaign[i].eStatus}</td>
				<td>
					<a href="{$tconfig.tpanel_url}/index.php?file=fu-fundraiser&mode=edit&iCampaignId={$db_fundcampaign[i].iCampaignId}" title=""><img src="{$tconfig.tpanel_img}icons/icon_edit.png" title="Edit" /></a>
					<a href="javascript:void(0);" title="Active" onclick="MakeAction('{$db_fundcampaign[i].iCampaignId}','Active');"><img src="{$tconfig.tpanel_img}icons/icon_approve.png" title="Active" /></a>
					<a href="javascript:void(0);" title="Inactive" onclick="MakeAction('{$db_fundcampaign[i].iCampaignId}','Inactive');"><img src="{$tconfig.tpanel_img}icons/icon_unapprove.png" title="Inactive" /></a>
					<a href="javascript:void(0);" title="Delete" onclick="MakeAction('{$db_fundcampaign[i].iCampaignId}','Deletes');"><img src="{$tconfig.tpanel_img}icons/icon_delete.png" title="Delete" /></a>
				</td>
				<td><input name="iCampaignId[]" type="checkbox" id="iId" value="{$db_fundcampaign[i].iCampaignId}"/></td>
			</tr>
		{/section}
		{else}
		<tr>
