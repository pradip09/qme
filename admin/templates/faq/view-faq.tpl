...
<div class="container">
    ...
    {/if}
        ...
        {/if}
        <tr class="{$class}">
			<td><a href="{$tconfig.tpanel_url}/index.php?file=fa-faq&mode=edit&iFAQId={$db_faq[i].iFAQId}" title="">{$db_faq[i].vQuestion}</a></td>
			<td>{$db_faq[i].iOrderNo}</td>
			<td>{$db_faq[i].eStatus}</td>
			<td>
				<a href="{$tconfig.tpanel_url}/index.php?file=fa-faq&mode=edit&iFAQId={$db_faq[i].iFAQId}" title=""><img src="{$tconfig.tpanel_img}icons/icon_edit.png" title="Edit" /></a>
