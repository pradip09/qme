...
jQuery(document).ready(function() {
	jQuery("#nav > li > a.collapsed + ul").slideToggle("medium");
...
// Notifications Pop-Up functionality
	...
	jQuery(document).ready(function(){
	   		jQuery("a.notifypop").bind('click', function(){
		 	 jQuery("#notificationsbox").bPopup();
		  	 return false
			});
		});
...
jQuery(document).ready(function(){
 	jQuery('table.pie').visualize({type: 'pie', height: '300px', width: '620px'});
	jQuery('table.bar').visualize({type: 'bar', height: '300px', width: '620px'});
	jQuery('table.area').visualize({type: 'area', height: '300px', width: '620px'});
	jQuery('table.line').visualize({type: 'line', height: '300px', width: '620px'});
});
		
// Tab Switching

	jQuery(document).ready(function(){
		jQuery("#tabs, #graphs").tabs();
	});
