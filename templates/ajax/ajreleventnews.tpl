...
{section name=i loop=$relevent_news}
 <div class="newswrap" style="margin-top: 18px;">
			<a href="{$site_url}/detail_news/{$relevent_news[i].iNewsId}"> <img src="{$relevent_news[i].vImage}" width="64" height="64"/></a>
     		...
     		<div class="topnews_nfl">
         		<span class="news_title"><a style="color: #4D85AC;text-decoration: none;" href="{$site_url}/detail_news/{$relevent_news[i].iNewsId}">{$relevent_news[i].vTitle}</a></span>
     ...
     <a href="#">More</a>
      ...
      <div class="likebox_activity">
			...
			<ul class="navact">
		       ...
		       <li><a style="color: #999;" href="javascript:void(0);" class="likeicon" id="likenews{$relevent_news[i].iNewsId}" onclick="qmelikenews('{$relevent_news[i].iNewsId}','{$mem_info[0].iMemberId}','news','{$relevent_news[i].iNewsId}','1');">Q Like</a></li>
		       <li><a href="#Share" id="share{$relevent_news[i].iNewsId}" class="shareicon">Share this</a></li>
		       <li><a style="color: #999;" href="javascript:void(0);" class="qtagicon">Qtag</a></li>
		       <li ><a style="color: #999;" href="#popmsg{$relevent_news[i].iNewsId}"   class="commenticon" >Post Comment</a></li>
		       	
				</ul>
			
						 
						 </div> <!--likebox actitivey feed box ends here-->
     
     
     
     </div> <!--commentwrap ends here-->
	...
	<form id="frm_msg{$relevent_news[i].iNewsId}" enctype="multipart/form-data"  method="POST" name="frm_msg">
		...
		<div class="btncommnet">
			<input class="btnbg " type="button" value="Send message" onclick="postMsg('Private','{$relevent_news[i].iNewsId}','{$relevent_news[i].iPostMemberId}');" style="float:right;margin-right: 0px;">
			<div class="cl"></div>
		</div>
	</form>
	</div>
...
{section name=i loop=$db_bloglistmatch}
 <div class="newswrap">
          		...
          		<img src="{$db_bloglistmatch[i].vImage}" width="64" height="64">
                
          
     		
     
     			<div class="topnews_nfl">
         		<span class="news_title"><a style="color: #4D85AC;text-decoration: none;"  href="{$site_url}/blog_detail/{$code}/{$db_bloglistmatch[i].iBlogId}">{$db_bloglistmatch[i].vBlogTitle}</a></span>
     ...
     <a href="#">More</a>
     ...
     </div> <!--top comments box ends here-->
      ...
      <div class="likebox_activity">
			...
			<ul class="navact">
		       ...
		       <li><a href="#Share" id="share{$db_bloglistmatch[i].iBlogId}" class="shareicon">Share this</a></li>
		       <li><a style="color: #999;" href="javascript:void(0);" class="qtagicon">Qtag</a></li>
		       <li><a style="color: #999;" href="#popmsg{$db_bloglistmatch[i].iBlogId}"  class="commenticon">Post Comment</a></li>
 ...
 <div style="display:none">
	<div id="popmsg{$db_bloglistmatch[i].iBlogId}" class="readpoppup">
	<form id="frm_msg{$db_bloglistmatch[i].iBlogId}" enctype="multipart/form-data"  method="POST" name="frm_msg">
		...
		<div class="btncommnet">
			<input class="btnbg " type="button" value="Send message" onclick="postMsg('Private','{$db_bloglistmatch[i].iBlogId}','{$db_bloglistmatch[i].iPostMemberId}');" style="float:right;margin-right: 0px;">
			<div class="cl"></div>
		</div>
	</form>
	</div>
...
<div class="more_recent_activity">
    {if $totRec gt $rec_limit}
        <a onclick="publicreleventnews({$start},{$iMemberId})" style="cursor:pointer;">More Relevent News <img src="{$tconfig["front_images"]}bot-arrow.png" alt="" title="" /><div class="ProcessingIndicationPublic Navigation Publicnews" id="releventnews_loading"></div></a>
