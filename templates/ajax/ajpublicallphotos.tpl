...
<div class="album_reapt_box">
	<div class="album_reapt_img"><a class="fancybox-thumb" rel="fancybox-thumb" href="{$PhotoArr[i].vImage}"><img src="{$PhotoArr[i].vImage}" style="width:157px;height:126px;"/></a></div>
	<div class="album_reapt_text"> {$PhotoArr[i].vPhotoTitle}<br />
...
<!--<li>
		...
		<img src="{$tconfig["front_images"]}delete.1.png" title="delete photo" onclick="deleteitem({$PhotoArr[i].iPhotoId},'image');" style="cursor:pointer;padding-left:5px;"/></li>
...
{/literal}
<div style="display:none"> {literal}
	<script type="text/javascript">
		    $(document).ready(function() {
