...
<table cellpadding="0"  cellspacing="0" background="0">
<tr>
             <td class="detail_name"><div class="playicon" id="displaydiv{$SongArr[i].iSongId}"><a href="#"><img src="{$tconfig["front_images"]}play-icon.png" alt="" title=""  onclick="playmusic('{$SongArr[i].iSongId}','{$SongArr[i].vSong}','{$SongArr[i].iMemberId}')"/></a>
             </div>{$SongArr[i].vSongTitle}
