...
<div class="timeline-view clearfix first">
		      ...
		      <span class="comment"><a href="javascript:void(0);" id="news{$relevent_news[i].iNewsId}" onclick="showcomment2('{$relevent_news[i].iNewsId}','{$mem_info[0].iMemberId}','news','{$relevent_news[i].iNewsId}');">Comments</a>&nbsp;<a href="javascript:void(0);" id="countcomnews{$relevent_news[i].iNewsId}"></a></span></div>
                </div>	
                </div>
		   <div class="cl"></div>
                </div>
...
{section name=i loop=$db_bloglistmatch}
	...
	<div class="timeline-view clearfix first">
		...
		<div class="action">
                      <ul class="clearfix"> 				<li class="a1"><a href="javascript:void(0);" id="likeblogs{$db_bloglistmatch[i].iBlogId}" onclick="qmelike('{$db_bloglistmatch[i].iBlogId}','{$mem_info[0].iMemberId}','Blog','{$db_bloglistmatch[i].iBlogId}','1');">Qlike</a></li>
