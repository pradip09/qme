...
<div class="campaignwrap" style="margin-left: 75px;">
	...
	<div class="leftcontent" id="displayboxdiv{$CampaginArr[i].iCampaignId}">
	<img src="2_{$CampaginArr[i].vImage}"/>
    </div></div>
   ...
   <div class="bottom_area">
	...
	<ul class="navlinks">
		<li > {if $CampaginArr[i].vVideoFile neq ''}<a   onclick="showdataonmaindiv1('{$CampaginArr[i].iAdminId}','{$CampaginArr[i].iMemberId}','{$CampaginArr[i].vVideoFile}','{$CampaginArr[i].iCampaignId}','video','{$CampaginArr[i].iPointsCommercialAd}');" class="btncommercial">View Commercial</a>{else}<a  class="btncommercial_blank"></a>{/if}</li>
		<li > {if $CampaginArr[i].vMp3File neq ''}<a  onclick="showdataonmaindiv1('{$CampaginArr[i].iAdminId}','{$CampaginArr[i].iMemberId}','{$CampaginArr[i].vMp3File}','{$CampaginArr[i].iCampaignId}','radio','{$CampaginArr[i].iPointsListenAd}');" class="btnradio">Play Radio Ad</a>{else}<a  class="btnradio_blank"></a>{/if}</li>
		...
		{if $CampaginArr[i].iProductId neq 0}
		<li> <a style="cursor:pointer;" href="#" onclick="buyProduct('{$CampaginArr[i].iMemberId}','{$CampaginArr[i].iCampaignId}','{$CampaginArr[i].iProductId}','{$CampaginArr[i].iStoreCategoryId}');" class="btnbuy">Buy this product</a></li>
		{/if}
	</ul>
    </div>
    <div class="accept_area">
