...
<div class="desboard_body" id="services_boxinnerbg">
	<div class="myphoto_album_container">
		...
		<div class="myphoto_album_img myphoto_album_slider">
			<div class="myphoto_album_title">{$db_user[0].vName}'s Video Albums</div>
			<div class="slidergelleri">
				<div class="slider-img_box">
					<ul id="sliderlist">
						{section name=i loop=$VideoCategoryArr}
						<li>
							<div class="album_reapt_img"><a href="javascript:void(0);" onclick="publicprofileallvideos(0,'{$VideoCategoryArr[i].iVideoAlbumId}','{$iMemberid}');"> <img src="{$VideoCategoryArr[i].vImage}" width="110" height="102" /></a></div>
							<div class="album_reapt_text_frntpage"> {$VideoCategoryArr[i].vVideoAlbum}<br />
		...
		<div class="slider_botvedio_box" style="min-height: 310px;">
			<div class="ProcessingIndication Navigation Myaccount" id="publicphotoalbum_loading" style="margin-left:20%;margin-top:16%;">Please Wait Video albums Loading...</div>
			<div id="myallvideos"></div>
			<div class="cl"></div>
		</div>
	</div>
</div>
...
publicprofileallvideos(0,0,'{/literal}{$iMemberid}{literal}');
