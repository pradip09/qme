...
<div class="desboard-right">
	...
	<div class="paddingleftright graybox1">
		...
		<div class="per_info_container_store">
			<form name="frmpaydetail" id="frmpaydetail" method="post" action="{$site_url}/index.php?file=m-buypnt_upgrade">
			{if $points neq ''}	
			<input type="hidden" value="{$price}" name="price">
			<input type="hidden" value="{$points}" name="point">
			{elseif $points11 neq ''}
			<input type="hidden" value="{$price11}" name="price">
			<input type="hidden" value="{$points11}" name="point">
			{/if}
