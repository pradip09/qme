...
<div class="desboard_body" id="services_boxinnerbg">
        <div class="public_pro_container">
                ...
                <div class="myphoto_album_img">
                        ...
                        <div class="detail_left_part" style="float:left; width:165px;"><img src="{$db_photoalbum[0].vImage}" title="Photoalbum" width="150px;" height="150px;"/></div>
                        <div class="detail_right_part">
                                ...
                                <div class="member_part">
                                        <div class="member_l">Photo album:</div>
                                        <div class="member_r">{{$db_photoalbum[0].vPhotoCategory}}</div>
                                </div>
                                <div class="member_part">
                                        <div class="member_l">Date:</div>
                                        <div class="member_r">{{$db_photoalbum[0].dAddedDate}}</div>
                                </div>
                        </div>
                        </div>
                        <div class="cl"></div>
