...
<div class="desboard_body" id="services_boxinnerbg">
        <div class="public_pro_container">
                ...
                <div class="myphoto_album_img">
                        ...
                        <div class="detail_left_part" style="float:left; width:165px;"><img src="{$db_vidalbum[0].vImage}" title="video album"  width="150px;" height="150px;"/></div>
                        <div class="detail_right_part">
                                ...
                                <div class="member_part">
                                        <div class="member_l">Video Album:</div>
                                        <div class="member_r">{{$db_vidalbum[0].vVideoAlbum}}</div>
                                </div>
                                <div class="member_part">
                                        <div class="member_l">Date:</div>
                                        <div class="member_r">{{$db_vidalbum[0].dAddedDate}} </div>
                                </div>
                        </div>
                        </div>
                        <div class="cl"></div>
