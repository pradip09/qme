...
<div class="desboard_body" id="services_box">
        <div class="public_pro_container">
                ...
                <div class="top_album_img">
                        <img src="{$tconfig["tsite_upload_images_member"]}/{$db_user[0].iMemberId}/3_{$db_user[0].vProfileImage}" alt="" width="70" height="56" />
                </div>
                ...
                <div class="myphoto_album_img">
                        ...
                        <div class="detail_left_part" style="float:left; width:225px; "><img src="{$tconfig["tsite_upload_images_member"]}/{$db_user[0].iMemberId}/2_{$db_user[0].vProfileImage}" title="Postjob" width="200px;" height="200px;"/></div>
                        <div class="detail_right_part" style="float: right;
width: 633px;">
                                ...
                                <div class="member_part">
                                        <div class="member_l">What skill are you looking for:</div>
                                        <div class="member_r">{{$db_postjob[0].vSkill}}</div>
                                </div>
                                <!-- <div class="member_part">
                                 ...
                                 <div class="member_part">
                                        ...
                                        <div class="member_r">{{$db_postjob[0].dAddedDate}}</div>
                                </div>
                                <div class="member_part">
                                        <div class="member_l">What do you need this person to do:</div>
                                        <div class="member_r">{{$db_postjob[0].tDescription}}</div>
                                </div>
                             ...
                             <!--   <div class="member_part">
                                ...
                                <div class="member_part">
                                        ...
                                        <div class="member_r">{{$db_postjob[0].vCity}}</div>
                                </div>-->
