...
<div class="desboard_body" id="services_boxinnerbg" style="padding-top:1px;">
        <div class="public_pro_container">
                ...
                <div class="myphoto_album_img">
                        ...
                        <div class="detail_left_part" style="float:left; width:165px;"><img src="{$db_photo[0].vImage}" title="photo" width="150px" height="150px"/></div>
                        <div class="detail_right_part">
                                ...
                                <div class="member_part">
                                        <div class="member_l">Photo Title:</div>
                                        <div class="member_r">{{$db_photo[0].vPhotoTitle}}</div>
                                </div>
                                <div class="member_part">
                                        <div class="member_l">Date:</div>
                                        <div class="member_r">{{$db_photo[0].dAddedDate}} </div>
                                </div>
                                <div class="member_part">
                                        <div class="member_l">Photo categoty:</div>
                                        <div class="member_r">{{$db_photocategory[0].vPhotoCategory}} </div>
                                </div>
                        </div>
                        </div>
                        <div class="cl"></div>
