...
<div class="PostCampaignTitle"> {if $mode eq 'add'}
	<div class="PostCampaignTitleBg">Create a Campaign</div>
	{else}
	<div class="PostCampaignTitleBg">Edit a Campaign</div>
	{/if} </div>
...
<form id="frmPostCampaign" name="frmPostCampaign" method="post" enctype="multipart/form-data" action="{$site_url}/index.php?file=a-ajpostcampaign">
	...
	<input type="hidden" name="vOldImage" id="vOldImage" value="{$db_campaign[0].vImage}" />
	...
	<table cellspacing="7" cellpadding="0">
		...
		<tr>
			...
			<td class="postcom_input"><div class="myprofile_select_box"> {if  $db_interest|@count gt 0}
					<div class="event_skill" style="height:75px;float:left;margin-bottom: 7px;">
						{section name=j loop=$db_interest}
						<div class="event_slikk_inner">
							<input style="margin-right:4px;" type="checkbox" value="{$db_interest[j].iInterestId}" id="iInterestId" name="iInterestId[]" {if $db_interest[j].iInterestId|in_array:$relatedArrIntrest}checked{/if}/>
		...
		<tr>
			...
			<td class="postcom_input"><div class="myprofile_select_box"> {if  $db_skill|@count gt 0}
					<div class="event_skill" style="height:75px;float:left;margin-bottom: 7px;">
						...
						<div class="event_slikk_inner">
							<input style="margin-right:4px;" type="checkbox" value="{$db_skill[j].iSkillId}" id="iSkillId" name="iSkillId[]" {if $db_skill[j].iSkillId|in_array:$relatedArr}checked{/if}/>  {$db_skill[j].vSkill}</div>
						{/section} </div>
					{/if}
		...
		<tr>
			<td class="postcom_label"><span class="mandatory">*</span>Choose mile radius&nbsp; <br/>from your location :</td>
		...
		<tr>
			<td class="postcom_label">Is this a national&nbsp; <br/> campaign? :</td>
			<td class="postcom_checkboxbtn"><input style="margin-top: 5px;" type="checkbox" id="eIsNational" name="eIsNational" {if $db_campaign[0].eIsNational eq 'Yes'}checked{/if}/>
				Yes
				<!--<input type="checkbox" />No-->
			</td>
		</tr>
		<tr>
			<td class="postcom_label">Is this a local&nbsp; <br/> campaign? :</td>
			<td class="postcom_checkboxbtn"><input style="margin-top: 5px;" type="checkbox" id="eIsLocal" name="eIsLocal" {if $db_campaign[0].eIsLocal eq 'Yes'}checked{/if}/>
				Yes
				<!--<input type="checkbox" />No -->
			</td>
		</tr>
		<tr>
			<td class="postcom_label">Do you Want this ad&nbsp; <br/> to appear in QME&nbsp; <br/> Search Engine&nbsp; <br/> Results? :</td>
			<td class="postcom_checkboxbtn"><input style="margin-top: 5px;" type="checkbox" id="eIsLocal" name="eIsLocal" {if $db_campaign[0].eIsLocal eq 'Yes'}checked{/if}/>
				Yes
				<!--<input type="checkbox" />No -->
		...
		<tr>
			<td class="postcom_label"><span class="mandatory">*</span>Points for viewing&nbsp; <br/>ad :</td>
			<td class="postcom_input"><div class="input_side_text">
	...
	<table cellspacing="7" cellpadding="0">
		<tr>
			...
			<td class="postcom_input"><input type="text" id="vBuyLinkURL" name="vBuyLinkURL" value="{$db_campaign[0].vBuyLinkURL}" onchange="checkurl(this.value)"/>
			</td>
		</tr>
		<tr><td class="postcom_label"></td><td class="postcom_input">[ You have to mention "http://" before link]</td></tr>
		<tr>
			<td class="postcom_label">Item Cost :</td>
			<td class="postcom_input"><input type="text" id="iItemCost" name="iItemCost" value="{$db_campaign[0].iItemCost}" onkeypress="return checkprice(event);"/>
			</td>
		</tr>
		<tr>
		...
		<!--<tr>
			<td class="postcom_label">Discount translate into points when <br/>
				members buy :</td>
			<td class="postcom_input"><div class="input_side_text">
					<input type="text" id="iPontsWhenBuy" name="iPontsWhenBuy" value="{$db_campaign[0].iPontsWhenBuy}" onkeypress="return checkprice(event);"/>
				</div>
				<div class="question_mark_btn"> <a class="tooltip" href="javascript:void(0);"> <img src="{$tconfig["front_images"]}question-mark.png" class="questionmark_icon" alt="" title="" /> <span class="custom help"> <img src="{$tconfig["front_images"]}Help.png" class="help_img" height="48" width="48" /> {$db_tooltips[10].vToolTipText} </span> </a> </div></td>
		</tr>-->
	</table>
	</table>
	<div class="PostCampaignTitle">
	...
	<table cellspacing="7" cellpadding="0">
		...
		<tr>
			...
			<td class="postcom_checkboxbtn" style="color:#000">
				<input type="checkbox" id="eEarnPoints" name="eEarnPoints" {if $db_campaign[0].eEarnPoints eq 'Yes'}checked{/if} onchange="check(this.id);"/>
				</td>
		</tr>
		<tr>
			<td class="postcom_label5">Purchase Points</td>
			<td class="postcom_checkboxbtn" style="color:#000">
				<input type="checkbox" id="ePurchagePoints" name="ePurchagePoints" {if $db_campaign[0].ePurchagePoints eq 'Yes'}checked{/if} onchange="check(this.id);"/>
				</td>
		</tr>
	...
	<table cellspacing="0" cellpadding="0" class="campaign_middle_form">
		...
		<tr>
			<td class="postcom_label">Number of members &nbsp;<br/> who match this &nbsp;<br/> campaign in my &nbsp;<br/> community   :</td>
			<td class="postcom_input"><div class="input_side_text">
		...
		<tr>
			<td class="postcom_label5">Share with this &nbsp;<br/> group?  &nbsp;</td>
			<td class="postcom_checkboxbtn post_cam_border_bot"><input style="margin-top: 5px;" type="checkbox" id="eSendEachMyCommunity" name="eSendEachMyCommunity" {if $db_campaign[0].eIsShareGroupIn eq 'Yes'}checked{/if}/>
				Yes </td>
		</tr>
		<tr>
			<td class="postcom_label">Number of members &nbsp;<br/>
				who match this &nbsp;<br/> 
				campaign outside &nbsp;<br/>
				of my community  :</td>
			<td class="postcom_input"><div class="input_side_text">
		...
		<tr>
			<td class="postcom_label5">Share with this &nbsp;<br/> group? &nbsp;</td>
			<td class="postcom_checkboxbtn post_cam_border_bot"><input style="margin-top: 5px;" type="checkbox" id="eSendEachOutCommunity" name="eSendEachOutCommunity" {if $db_campaign[0].eIsShareGroupOut eq 'Yes'}checked{/if}/>
				Yes </td>
		</tr>
		<tr>
			<td class="postcom_label">Number of members &nbsp;<br/>
				who support biz in &nbsp;<br/> 
				my community :</td>
			<td class="postcom_input"><div class="input_side_text">
		...
		<tr>
			<td class="postcom_label5">Share with this &nbsp;<br/> group? &nbsp;</td>
			<td class="postcom_checkboxbtn post_cam_border_bot"><input style="margin-top: 5px;" type="checkbox" id="eSendEachSupportBiz" name="eSendEachSupportBiz" {if $db_campaign[0].eIsShareGroupBiz eq 'Yes'}checked{/if}/>
				Yes </td>
		</tr>
		<tr>
			<td></td>
...
function check(id){
	//alert(id);
      if(id == 'eEarnPoints')
      {
	    $('#ePurchagePoints').attr('checked',false);
	    
      }
      if(id == 'ePurchagePoints')
      {
	    $('#eEarnPoints').attr('checked',false);
