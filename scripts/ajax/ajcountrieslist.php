...
if($countryId !=''){
   ...
   $html = '';
  $html .= '<select name="iStateId" id="iStateId" class="select_input" title="State" lang="*" style="width:320px;" >'; 
  ...
  for($i=0;$i<count($db_realestatestate);$i++){
      ...
      $html .= '<select>';
        ...
        $html .= '<select name="iStateId" id="iStateId" class="select_input" style="width:320px;" >'; 
            $html .= '<option value="">----Select State----</option>';
        $html .= '<select>';    
    } 
