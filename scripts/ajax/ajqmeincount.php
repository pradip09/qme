...
$sql_top = "SELECT m. * , MAX( iRecentActivityId ) FROM members m LEFT JOIN recent_activities r ON ('m.iMemberId = r.iMemberId') where m.iMemberId=".$memberId[$i]." GROUP BY iMemberId ORDER BY iRecentActivityId DESC  LIMIT 0 , 50"; 
