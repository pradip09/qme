<?php
   ...
   $html .= '<div class="btncommnet" onclick="savecomment1('.$recent_activitieId.','.$user_id.',\''.$comment_type.'\','.$item_id.');"><input name="" type="button" class="btnbg " style="float:right;" value="comment" /></div><div class="cl"></div></div></div>';
   $html .= '</div>';
