...
class Paging
{
	...
	public function displayBrowseJobPaging($tot)
	{
		...
		if($start_loop > $page_limit)
		{
			...
			$this->page_string.="<li style='float:left'><a style='border:none;cursor:pointer' onclick='javascript:".$this->JSFunc."(\"".$prev_loop."\");' title='anterior'>Previous</a>&nbsp;</li>";
	    }
		...
		if($start_loop<=$tot_pages)
			$this->page_string.="<li style='float:left'><a  style='border:none;cursor:pointer' onclick='javascript:".$this->JSFunc."(\"".$start_loop."\");'; title='Next'>Next</a></li>";
			$this->page_string.="</ul>";
		$this->page_string.="</div>";
		
		return $this->page_string;
	}
	public function displayBrowseCampaignPaging($tot)
	{
		...
		if($start_loop<=$tot_pages)
			$this->page_string.="<li style='float:left'><a  style='border:none;cursor:pointer' onclick='javascript:".$this->JSFunc."(\"".$start_loop."\");'; title='pr&oacute;ximo'>next</a></li>";
			$this->page_string.="</ul>";
		$this->page_string.="</div>";
